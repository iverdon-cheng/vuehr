        ...
        <el-dialog
            ...
            <div>
                <div style="margin-left: 10px">
                    <el-tag>职称名称</el-tag>
                    <el-input size="small"  style="width: 50%; margin-left: 10px" v-model="updateJl.name"></el-input>
                </div>

                <div style="margin-left: 10px; margin-top: 5px">
                    <el-tag>职称级别</el-tag>
                        <el-select v-model="updateJl.titleLevel" placeholder="职称等级" size="small" style="margin-left: 10px ; margin-right: 5px">
                            <el-option
                                    v-for="item in titleLevels"
                                    :key="item"
                                    :label="item"
                ...
                <div style="margin-left: 10px; margin-top: 5px">
                    <el-tag>是否启用</el-tag>
                    <el-switch style="margin-left: 12px"
